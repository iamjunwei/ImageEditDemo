...
public class DemoImageViewStable2 extends View {
    ...
    public DemoImageViewStable2(Context context) {
        super(context);
        init();
    }

    public DemoImageViewStable2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DemoImageViewStable2(Context context, AttributeSet attrs, int defStyleAttr) {
